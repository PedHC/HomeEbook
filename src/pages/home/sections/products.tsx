...
import CardImage from "@assets/images/pain.png";
import CommonButton from "components/button";
import { ScrollHome } from "utils/common";
import { TextOrange } from "../style";
...
function ProductCard({ title, image, description, list }: Props) {
  return (
    <Card sx={{ textAlign: "center", height: "auto", background: "#000" }}>
      <Typography fontSize={18} height={"55px"}>
        {title}
      </Typography>
    ...
    <section className="section section-products">
      <Box>
        <Typography
          ...
          marginBottom={"1.5rem"}
        >
          QUAIS SÃO OS <TextOrange>PRODUTOS CAMPEÕES EM VENDAS</TextOrange> QUE
          VOCÊ IRÁ RECEBER?
        </Typography>
        ...
        <Box sx={{ textAlign: "center", marginTop: 15 }}>
          {" "}
          <CommonButton text="EU QUERO ESSES PRODUTOS" click={ScrollHome} />
        </Box>
      </Box>
    </section>
  );
